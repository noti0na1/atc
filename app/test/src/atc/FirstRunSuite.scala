...
class FirstRunSuite extends munit.FunSuite:
  ...
  private final class Script(answers: Option[String]*) extends FirstRun.Ui:
    private val pending = scala.collection.mutable.Queue(answers*)
  ...
  private def listing(asked: scala.collection.mutable.ListBuffer[Option[String]])(spec: ModelSpec): List[ModelSpec] =
    asked += spec.apiKey
